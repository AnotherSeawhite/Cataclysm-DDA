...
#   endif
        ...
        add( "VSYNC", page_id, to_translation( "Use VSync" ),
             to_translation( "Enable vertical synchronization to prevent screen tearing.  VSync can slow the game down a lot.  Requires restart." ),
             false, COPT_CURSES_HIDE
           );
#endif
#if defined(__ANDROID__)
